    ...
    companion object {
        ...
        fun setViewPaddingToFloatKeyboard(
            ...
            decorView.viewTreeObserver.addOnGlobalLayoutListener(ViewTreeObserver.OnGlobalLayoutListener {
                ...
                val keyboardHeight =
                    decorViewBottom - (displayRect.bottom + navigationBarHeight)

                Log.d(
                    "日志",
                    "键盘监听 ___ displayRect.bottom = ${displayRect.bottom}  decorView.bottom = $decorViewBottom  keyboardVisible = $keyboardVisible  keyboardHeight = $keyboardHeight   navigationBarHeight =  $navigationBarHeight  statusBarHeight = $statusBarHeight paddingBottom =  ${viewParent.paddingBottom}"
                )
