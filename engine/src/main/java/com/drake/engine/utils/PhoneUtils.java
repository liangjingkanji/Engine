...
public class PhoneUtils {
  ...
  public static boolean isPhone() {
      TelephonyManager tm = (TelephonyManager) Engine.INSTANCE.getApp()
  ...
  public static void call(String phoneNumber) {
      Engine.INSTANCE.getApp().startActivity(IntentUtils.getCallIntent(phoneNumber));
  }
  ...
  public static void sendSms(String phoneNumber, String content) {
      Engine.INSTANCE.getApp().startActivity(IntentUtils.getSendSmsIntent(phoneNumber, content));
  }
  ...
  public static void sendSmsSilent(String phoneNumber, String content) {
    if (TextUtils.isEmpty(content)) {
      ...
      PendingIntent sentIntent = PendingIntent.getBroadcast(Engine.INSTANCE.getApp(), 0, new Intent(), 0);
  ...
  public static List<HashMap<String, String>> getAllContactInfo() {
    ...
    // 1.获取内容解析者
      ContentResolver resolver = Engine.INSTANCE.getApp().getContentResolver();
